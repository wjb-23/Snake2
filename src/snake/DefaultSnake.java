...
/**
 * Constructs a graphics group and list to create default snake option.
...
public class DefaultSnake implements Snake{
    ...
    public static final int initialLength = 6;
    public final double bodySize = 12;
    ...
    public void setSnakeHead(String path){
        snakeHead.setImagePath(path);
    }
    ...
    public void move(double dx, double dy) {
        ...
        listGraphics.get(listGraphics.size() - 1).setCenter(listGraphics.get(0).getCenter());
    ...
    public boolean wallCollision(CanvasWindow canvas){
        if(canvas.getElementAt(listGraphics.get(0).getX() + bodySize, listGraphics.get(0).getY() + 0.5 * bodySize) instanceof Wall) {
            return true;
        } if (canvas.getElementAt(listGraphics.get(0).getX(), listGraphics.get(0).getY() + 0.5 * bodySize) instanceof Wall) {
            return true;
    ...
    public String toString() {
        return "DefaultSnake [bodySize=" + bodySize + ", graphics=" + graphics + ", interval=" + interval
